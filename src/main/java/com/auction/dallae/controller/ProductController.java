...
public class ProductController {
	...
	@RequestMapping(value = "/ProductInfo/{ProductNumber}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/ProductInfo/{ProductNumber}", method = RequestMethod.DELETE)
	@ResponseBody
	public Integer deleteProduct(@PathVariable Integer productNumber) {
		return productService.deleteProduct(productNumber);
	}
	@RequestMapping(value = "/ProductInfo/{ProductNumber}", method = RequestMethod.POST)
	@ResponseBody
