...
public class UserInfo {
	...
	public UserInfo(Integer userNumber, String userName, String userId, String userPassword, String userEmail,
			...
			String userLevel, Integer userPoint, String userCreditLevel, String userImage, String paww) {
		super();
	...
	public String toString() {
		return "UserInfo [userNumber=" + userNumber + ", userName=" + userName + ", userId=" + userId
				...
				+ userPoint + ", userCreditLevel=" + userCreditLevel + ", userImage=" + userImage + ", paww=" + paww
				+ "]";
	}
	...
	public String getPaww() {
		return paww;
	}


	public void setPaww(String paww) {
		this.paww = paww;
	}
