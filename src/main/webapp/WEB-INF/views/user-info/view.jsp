		...
		<c:choose>
			<c:when test="${userLevel>2.5}">
				...
				<div class="container">
							...
							<div class="col-md-6"
								...
								<div style="width: 70%; float: left;">
									...
									<p style="clear: both;">
										...
										<br>회원 No.<b>${userinfo.userNumber}</b> | 권한등급 LV <b>${userinfo.userLevel}</b><br>
										가입일 : ${userinfo.userSignUpDate}
									</p>
								</div>
					...
					<h3>
						<b> ${userinfo.userId}</b> 님의 경매품목입니다.
					</h3>
...
function save() {
	   ...
	   params = JSON.stringify(params);
	   var conf = {
	      url:'/update/'+${userinfo.userNumber},
	      method: 'PUT',
	      param: params,
	      success: function(res) {
	         /* alert(res) */
