...
<script>
	...
	function loadba() {
		...
		var au = new AjaxUtil(
				{
					url : '/productcategoryrarecollectionlist',
					param : params,
					method : 'POST',
					success : function(res) {
						...
						for (var i = 0; i < res.length; i++) {
							...
							html += '<a onclick="goPage('
									+ res[i].productNumber
									+ ')"><img style="width:100%;" alt="sell-img" src="/resources/img/product/';
							...
							html += '<h4>시작가격 : ' + res[i].productLowestPrice
									+ ' 원</h4>';
							html += '<h4>현재가격 : ' + res[i].productLowestPrice
									* 3 / 2 + ' 원</h4>';
							html += '<p>제품브랜드 : ' + res[i].productBrand
									+ ' | 판매자 : ' + res[i].userId
									+ ' | 제품수량 : ' + res[i].productQuantity
									+ ' | 분류 : ' + res[i].productCategory
									+ ' | 신용등급 : ' + res[i].userCreditLevel
									+ ' | 등록일 : ' + res[i].productDate
									+ ' | 마감일 : ' + res[i].productEndDate
									+ '</p>';
						...
						document.querySelector('#product-div')
