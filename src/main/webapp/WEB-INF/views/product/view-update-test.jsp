							...
							<div style="width: 33%; float: left;">
								<div class="fileBox">
									<label for="productImage" class="btn btn-default"
										...
										class="uploadBtn" name="productImage" value="${product.productImage}"> <img
										style="width: 100%"
								...
								<div class="fileBox">
									<label for="productImage2" class="btn btn-default"
										...
										class="uploadBtn"> <img name="preview" style="width: 100%"
...
for(var i=0;i<fileInputs.size;i++){
	fileInputs[i].addEventListener('change', function(e) {
		var url = URL.createObjectURL(e.target.files[0]);   
		previews[i].setAttribute('src', url);
	});
}
