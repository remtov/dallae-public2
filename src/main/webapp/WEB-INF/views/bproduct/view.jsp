				...
				<div class="container">
					...
					<div class="container" style="width: 100%;">
						...
						<form id="iform" enctype="multipart/form-data" method="POST">
							...
							<img style="width: 100%;"
								src="/resources/img/product/${product.productImage}"> <input
								class="form-control" type="file" name="productImage"
							...
							<table style="width: 100%;" border="1">
								<tr>
									<td rowspan="2"><img style="width: 50px; height: auto;"
										src="/img/icon_profile.png"></td>
...
<tr>
	<td>제품코드 :</td>
	<td><input required data-vc="3,10" class="form-control"
		type="text" name="productCode" value="${product.productCode}"></td>
</tr>
<tr>
	<td>제품수량 :</td>
	<td><input required data-vc="1,1000" required class="form-control"
		type="text" name="productQuantity" value="${product.productQuantity}"></td>
</tr>
<tr>
	<td>제품시간 :</td>
...
<tr>
	<td>제품상태 :</td>
	<td><input required data-vc="1,30" class="form-control"
		type="text" name="productCondition"
		value="${product.productCondition}"></td>
</tr>
<tr>
	<td>브랜드명 :</td>
	<td><input required data-vc="1,20" class="form-control"
		type="text" name="productBrand" value="${product.productBrand}"></td>
</tr>
<tr>
	<td>시작가격 :</td>
	<td><input required data-vc="1,1000000000" class="form-control"
		type="text" name="productLowestPrice"
		value="${product.productLowestPrice}"></td>
</tr>
<tr>
	<td>희망가격 :</td>
	<td><input required data-vc="1,1000000000" class="form-control"
		type="text" name="productHopefulPrice"
		value="${product.productHopefulPrice}"></td>
</tr>
<tr>
	<td>기타사항 :</td>
	<td><input required data-vc="1,300" class="form-control"
		type="text" name="productDesc" value="${product.productDesc}"></td>
</tr>
<tr>
	<td></td>
	<td><button class="btn btn-default btn-lg" type="button"
		...
		<button class="btn btn-danger btn-lg" type="button"
			onclick="dele(${product.productNumber})">주의! 데이터가 삭제됩니다.</button></td>
</tr>
</tbody>
</table>
</form>
