	...
	<div id="home_container">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${fashion.productCategory}</a></li>
				...
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${digital.productCategory}</a></li>
			...
			<div class="row">
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${rareCollection.productCategory}</a></li>
				...
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${healthBeauty.productCategory}</a></li>
			...
			<div class="row">
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${motorPartz.productCategory}</a></li>
				...
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${toyHobby.productCategory}</a></li>
			...
			<div class="row">
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${sports.productCategory}</a></li>
					...
					<div style="background-color: white;">
						...
						<div class="home-content_more-button">
							<p style="padding: 20px 0px 20px 20px;">
								<a href="#" class="btn btn-primary" role="button"> 입찰하기</a> <a
									style="margin-left: 10px;"
									href="/product/${sports.productNumber}"
									class="btn btn-default" role="button"> 더보기 </a>
							</p>
						</div>
					</div>
				...
				<div class="col-md-6">
					<ol class="breadcrumb2">
						<li><a href="#">${life.productCategory}</a></li>
